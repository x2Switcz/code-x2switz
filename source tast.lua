...
local key = _G.Key
local check = "https://x2switz.000webhostapp.com/cheack.php?key=" .. key
if game:HttpGet(check) == "Whitelisted" then
loadstring(game:HttpGet("https://x2switz.000webhostapp.com/script.lua"))()
else
game.Players.LocalPlayer:Kick("Not Key  you buy Key to x2switz#8882 Discord 150 baht")
end
...
game.StarterGui:SetCore("SendNotification", {
	Title = "x2switz Notification", 
	Text = "เธเธฑเธเธเธฑเนเธเธ—เธตเนเธกเธตเนเธญเธเธญเธเธเธตเนเธชเธฒเธกเธฒเธฃเธ–เน€เธเธดเธ”\nเธเธฃเนเธญเธกเธเธฒเธกเน€เธงเธฅเนเธ”เน",
